...
load("//plugins/devtools:deps.bzl", devtools = "maven")
...
maven = beacon + check_path + coroutines + devtools + expression + external_action + java_logger + metrics + pending_transaction + pubsub + reference_assets + set_time_out + slf4j_logger
