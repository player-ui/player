...
<Canvas>
  <Story name="Action Basic">
    <StoryWrapper>
      <DSLPlayerStory dslContent={(() => import('!!raw-loader!/plugins/reference-assets/mocks/action/action-basic.tsx'))}/>
    </StoryWrapper>
  </Story>
</Canvas>
...
<Canvas>
  <Story name="Transition To End">
    <StoryWrapper>
      <DSLPlayerStory dslContent={(() => import('!!raw-loader!/plugins/reference-assets/mocks/action/action-transition-to-end.tsx'))}/>
    </StoryWrapper>
  </Story>
</Canvas>