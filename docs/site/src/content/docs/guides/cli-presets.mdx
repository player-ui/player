...
import { Badge, FileTree, Steps } from '@astrojs/starlight/components';

CLI Presets are [CLI Configs](../../capabilities/cli#config) that are intended to be reused. They bundle together plugins, settings, and dependencies to provide a consistent development experience across projects.

## Creating a CLI Preset

This example will demonstrate a common user case of CLI presets: bundling common plugins and type definitions.
