...
- `@player-cli/cli` <Badge text="required"/>: The Player CLI package. It is required to define any CLI preset.
...
import { LSPAssetsPlugin, LSPPluginPlugin } from "@player-cli/cli";
