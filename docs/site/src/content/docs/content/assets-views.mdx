...
<ContentTabs>
  <Fragment slot='tsx'>
```tsx
import { Asset } from '@player-lang/react-dsl';
...
<ContentTabs>
  <Fragment slot='tsx'>
```tsx
import { View, expression as e, binding as b } from '@player-lang/react-dsl';
...
<ContentTabs>
  <Fragment slot='tsx'>
```tsx
import { Switch, Asset, expression as e, binding as b } from '@player-lang/react-dsl';
