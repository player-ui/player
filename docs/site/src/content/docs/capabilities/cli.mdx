...
Config files are searched using [cosmiconfig](https://github.com/cosmiconfig/cosmiconfig), which will look for the following files in order:

| File Name | Format |
|-----------|--------|
| `package.json` | JSON with a `player` property |
| `.playerrc` | JSON or YAML |
| `.playerrc.json` | JSON |
| `.playerrc.yaml` | YAML |
| `.playerrc.yml` | YAML |
| `.playerrc.js` | JavaScript (CommonJS) module exporting an object |
| `.playerrc.ts` | TypeScript module exporting an object |
| `.playerrc.mjs` | JavaScript (ES Module) module exporting an object |
| `.playerrc.cjs` | JavaScript (CommonJS) module exporting an object |
| `.config/playerrc` | JSON or YAML |
| `.config/playerrc.json` | JSON |
| `.config/playerrc.yaml` | YAML |
| `.config/playerrc.yml` | YAML |
| `.config/playerrc.js` | JavaScript (CommonJS) module exporting an object |
| `.config/playerrc.ts` | TypeScript module exporting an object |
| `.config/playerrc.mjs` | JavaScript (ES Module) module exporting an object |
| `.config/playerrc.cjs` | JavaScript (CommonJS) module exporting an object |
| `player.config.js` | JavaScript (CommonJS) module exporting an object |
| `player.config.ts` | TypeScript module exporting an object |
| `player.config.mjs` | JavaScript (ES Module) module exporting an object |
| `player.config.cjs` | JavaScript (CommonJS) module exporting an object |
