...
| `player.hooks.flowController`                               | [`FlowController`](/architecture/systems/flow-controller)                     | You want to observe or affect navigation transitions (via nested flow hooks).                |
| `player.hooks.viewController`                               | [`ViewController`](/architecture/systems/view-controller)                     | You want to react to view changes or update behavior.                                        |
| `player.hooks.view`                                         | [`ViewInstance`](/architecture/systems/view-controller)                       | You want to attach view-scoped behavior when a new view is entered.                          |
| `player.hooks.dataController`                               | [`DataController`](/architecture/systems/data-controller)                     | You want to observe or augment data pipeline behavior (sets, defaults, formatting, updates). |
| `player.hooks.expressionEvaluator`                          | [`ExpressionEvaluator`](/architecture/systems/expression-evaluator)            | You want to add/override expression functions or observe evaluation errors.                  |
| `player.hooks.schema` / `player.hooks.validationController` | [schema](/architecture/systems/schema-controller) + [validation](/architecture/systems/validation-controller) controllers | You need schema-driven formatting or validation behavior.                                    |
| `player.hooks.bindingParser`                                | [`BindingParser`](/architecture/systems/binding-parser)                       | You need custom binding parsing/routing or to wrap parse/evaluate plumbing.                  |
...
- [Hooks](/plugins/hooks)
- [Writing a Plugin](/guides/writing-plugins)
- [Plugin Implementation](/guides/plugin-implementation)
