...
This plugin assists with exposing custom expressions to Player content. See [ExpressionEvaluator](/architecture/systems/expression-evaluator) for the runtime engine these handlers are registered with.
