...
We provide a basic devtools plugin that displays information about the inspected Player Instance. [devtools/plugins/desktop/basic]. This is essentially a Player plugin that provides plugin information, flow, logs, and exposes a console for expression evaluation. It uses our devtools-assets to render the UI.
