...
Our Devtools player extension has been redesigned to work with manifest v3. It leverages plugins to handle communication between the inspected Player-UI instance and the devtools extension panel.
