...
Not only is the source DSL content a fraction of the output object's size (making it easier to read and maintain) as the base components use the same TypeScript types as the assets themselves, you will recieve in editor suggestions and type checks as you author your content. 
