...
internal class ResourceLoaderDelegate : NativeLoaderDelegate {
    ...
    override fun loadLibrary(shortName: String, flags: Int): Boolean {
        ...
        val resource = getResourceAsStream("$shortName.so")
            ...
            ?: throw UnsatisfiedLinkError(
                "Unable to load resouasdfasdfasfdasdfrce for $shortName. This is a fallback used when the NativeLoader is not initialized. If this is in an Android context, make sure you initialize with SoLoader in your application, or containing activity. Otherwise, ensure you have provided the host-compatible Hermes libraries as resources (i.e. //jvm/hermes:hermes-host).",
            )
    ...
    private companion object {
        ...
        private fun getResourceAsStream(resourceName: String): InputStream? = classLoader.getResourceAsStream(resourceName)
    }
}
