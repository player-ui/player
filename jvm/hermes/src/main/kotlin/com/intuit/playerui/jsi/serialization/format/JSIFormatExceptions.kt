...
internal open class JSISerializationException
    @InternalPlayerApi
    constructor(
        message: String?,
...
internal class JSIDecodingException
    @InternalPlayerApi
    constructor(
        message: String?,
        cause: Throwable? = null,
    ) : JSISerializationException(message, cause)

/** Thrown when [JSIFormat] has failed to create a JSON string from the given value */
internal class JSIEncodingException
    @InternalPlayerApi
    constructor(
        message: String?,
        cause: Throwable? = null,
