...
import com.intuit.playerui.core.bridge.serialization.json.PrettyJson
import com.intuit.playerui.core.bridge.serialization.serializers.NodeSerializableField.CacheStrategy
...
internal class NodeSerializableFieldTest : RuntimeTest() {
    ...
    @TestTemplate fun `throws when undefined`() {
        ...
        assertEquals(
            "Could not deserialize \"undefined\" as \"com.intuit.playerui.core.bridge.serialization.serializers.Structured(primitive: kotlin.Int, nested: com.intuit.playerui.core.bridge.serialization.serializers.Structured?)\"",
