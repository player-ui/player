...
internal open class GraalSerializationException
    @InternalPlayerApi
    constructor(
        message: String?,
...
internal class GraalDecodingException
    @InternalPlayerApi
    constructor(
        message: String?,
        cause: Throwable? = null,
    ) : GraalSerializationException(message, cause)

/** Thrown when [GraalFormat] has failed to create a JSON string from the given value */
internal class GraalEncodingException
    @InternalPlayerApi
    constructor(
        message: String?,
        cause: Throwable? = null,
