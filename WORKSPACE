...
http_archive(
    name = "rules_player",
    strip_prefix = "rules_player-0.1.0",
    urls = ["https://github.com/player-ui/rules_player/archive/refs/tags/v0.1.0.tar.gz"],
    sha256 = "0e81a0640e0f5d9ab9a2c8a8e50f4ac08869eff23cf41a05ee0529cebba45461",
)
