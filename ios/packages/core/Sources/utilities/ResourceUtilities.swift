...
public class ResourceUtilities {
     ...
     */
    public static func urlForFile(name: String, ext: String, bundle: Bundle, pathComponent: String) -> URL? {
        guard let bundleURL = bundle.resourceURL?.appendingPathComponent(pathComponent) else { return nil }
